...
/**
 * How far the organiser must scroll before the page's sticky "enquire" bar
 ...
 * one slides in, so the two never compete above the fold. The same
 * viewport-relative reasoning as `containers/wellness/hooks/useStickyCtaReveal`;
 * kept container-local so the events client bundle pulls nothing from wellness.
 */
